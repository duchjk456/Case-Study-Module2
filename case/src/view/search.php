    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <div class="row">
                ...
                <?php else:?>
                <h4 style="text-align: center;color: darkred">Có <?= count($products)?> sản phẩm phù hợp với kết quả bạn vừa tìm kiếm:</h4>
                <?php foreach ($products as $key => $item): ?>
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100">
                            <a href="index.php?page=detail&id=<?= $item->getId(); ?>"><img class="card-img-top" src="image/<?= $item->getImage(); ?>.jpg" alt="Hinh anh san pham"></a>
                            <div class="card-body">
                                <h4 class="card-title">
                                    <a style="color: darkred" href="index.php?page=detail&id=<?= $item->getId(); ?>"><?= $item->getProductName(); ?></a>
                                </h4>
                                <h5><?= number_format($item->getPrice(), 0, ",", "."); ?> VND</h5>
