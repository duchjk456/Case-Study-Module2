...
<body>
<h3 style="font-size: 40px;text-align: center;background-color:grey" >Thêm sản phẩm</h3>
<br>
<br>
<form action="index.php?page=adminAdd" method="post">
    <table align="center" class="table" style="width: 50%;border-radius: 15px;">
        ...
        <tr><td style="text-align: right">
            ...
            <td>
                <a onclick="return confirm('Bạn chắc chứ? Dữ liệu ở trang này sẽ không được lưu lại!')" class="btn btn-warning" href="index.php?page=adminCancel">Cancel</a>
            </td>
        </tr>
    </table>
</form>
